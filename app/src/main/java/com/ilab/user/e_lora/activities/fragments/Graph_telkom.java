 ...
 */
public class Graph_telkom extends Fragment {
    private static final String TAG = Graph_telkom.class.getSimpleName();
    ...
    private void get_most_recent_records(final View view){
        ...
        Call<HitsObject> call = apiInterface.get_most_recent_records_t();
